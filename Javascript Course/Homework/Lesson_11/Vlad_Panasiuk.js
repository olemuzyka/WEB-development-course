            ...
            success: function(data){
              for(i = 0; i < data.items.length; i++) {
               var dataItems = data.items[i].volumeInfo,
                ...
                results.innerHTML += "<button id='" + id + "' type='button''>" + "Заказать" + "</button><br></div>"
                ...
                $("#results button").on('click', function() {
                  ...
                  document.getElementById("bookOrder").innerHTML = ""
                   ...
                   bookOrder.innerHTML += "<img src='" + imgLinks + "'/>"
                   bookOrder.innerHTML += "<p>" + description + "</p>"

                   
                   orders.innerHTML += "<h2>" + title + "</h2>"
                   orders.innerHTML += "<img src='" + imgLinks + "'/>"
